...
<html>
	...
	<body>
		[회원 가입 폼]<br/>
		<form method="post" action="/kjhapp/exam11/memberJoin"><%-- method="post" 데이터를 본문에 담아 전송  --%>
			...
			직    업:<input type="radio" name="mjob" value="대학생">대학생<%--단일 선택 --%>
					<input type="radio" name="mjob" value="회사원" checked>회사원
					<input type="radio" name="mjob" value="공무원">공무원<br/>
					
			개발분야:<input type="checkbox" name="mskill" value="web">웹개발<%--중복 선택 []로 받음 --%>
			...
			생년월일:<input type="date"name="mbirth" value="2016-09-29"/>
					...
					--%>
					<input type="image"src="/kjhapp/resources/image/join.png"width="100" height="50"/><%-- 경로에 있는 이미지 클릭시 submit와 같다 --%> 
