...
public class ArrayCopyExample {
	...
	public static void main(String[] args) {
		...
		System.out.println("for문 복사 방법 -> "+Arrays.toString(arr2));//배열 안의 항목을 하나씩 출력
		...
		System.out.println("System.arraycopy문 복사 방법 -> "+Arrays.toString(arr3));//배열 안의 항목을 하나씩 출력(확인)

		//배열복사방법3
		//Arrays.copyOf(복사할 배열, 복사할 길이);
		char[] arr4 = Arrays.copyOf(arr1, arr1.length);
		System.out.println("Arrays.copyOf문 복사 방법 -> "+Arrays.toString(arr4));	//얕은 복사
	}
