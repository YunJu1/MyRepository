...
public class ByteToStringExample {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		//ASCII 번호 문자(숫자, 알파벳, 특수문자)에 0~255의 번호를 매김
		
		String str1 = new String(bytes);
		System.out.println(str1);
		
		String str2 = new String(bytes,6,4);//6번째 부터 4개 출력
		System.out.println(str2);
		
		String str3 = "홍길동";	//ASCII 표현 안됨.
		byte[] strBytes3 = str3.getBytes();	//바이트 배열로 변환 -> 문자를 2byte로 변환//기본 설정된 Charset으로 바이트 변환
		...
		//EUC-KR ASCII + UNICODE(한글을 2byte로 변경) -> 알파벳, 한글만 사용
		...
		//Encoding과 Decoding의 Charset는 같아야 한다.
		System.out.println(str6);
		
		String str7 = new String(strBytes5, 2, 6/*byte수*/,"EUC-KR");
		System.out.println(str7);
		
		//네트워크 통신할시 byte로 데이터를 전송하기 때문에 문자 복원시 사용 !
